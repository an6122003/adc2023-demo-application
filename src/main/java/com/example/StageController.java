...
public class StageController {
    ...
    public void switchToActiveMockupScene(ActionEvent event) throws IOException{
    ...
    public void switchToFrontPageAfterCaptureScene(ActionEvent event) throws IOException{
    ...
    public void switchToExpressScene(ActionEvent event) throws IOException{
    ...
    public void switchToSosScene(ActionEvent event) throws IOException{
        root = FXMLLoader.load(getClass().getResource("/com/example/SosPages/SosOptionPage.fxml"));
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
